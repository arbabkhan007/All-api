...
Turn the Excel workbook into a live Google Sheet with a **Hearth & Timber** menu.

## 5 minutes

1. Upload `Hearth_and_Timber_Home_Renovation_System.xlsx` to [Google Drive](https://drive.google.com).

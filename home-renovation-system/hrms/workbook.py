...
def _sheet(wb, title, tab, last_col=14, subtitle=""):
    ...
    banner(ws, title.upper(), subtitle or "Hearth & Timber  ·  digital twin of the home", last_col, tab)
    page_setup(ws, title)
...
def build_dashboard(wb):
    ...
    section_label(ws, 36, 8, "QUICK ACTIONS  (use the Hearth & Timber menu in Google Sheets)", 6)
    actions = [
        (37, "+ Expense"),
        (38, "+ Task"),
...
def build_start(wb):
    ...
    ws["A4"] = "Hearth & Timber  ·  Home Renovation Management System"
    ...
    steps_gs = [
        ...
        "4. Reload the sheet. A “Hearth & Timber” menu appears.",
        "5. Use the menu to add expenses/tasks and send maintenance reminders.",
...
def build_workbook() -> Workbook:
    ...
    wb.properties.title = "Hearth & Timber — Home Renovation Management System"
    wb.properties.creator = "Hearth & Timber"

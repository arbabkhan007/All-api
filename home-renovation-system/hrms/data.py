"""Sample data for the Hearth & Timber Home Renovation Management System.
...
SETTINGS = [
    ...
    ("Support Email", "studio@hearthandtimber.example"),
...
USERS = [
    ...
    ["AD-001", "Morgan Ellis", "morgan@hearthandtimber.example", "+1-503-555-0100", "Admin", "Hearth & Timber", "Active", date(2026, 8, 24), "System admin, all properties"],
    ...
    ["AC-001", "Jamie Cole", "jamie@hearthandtimber.example", "+1-503-555-0108", "Accountant", "Hearth & Timber", "Active", date(2026, 8, 24), "Invoices, tax, payments"],
]

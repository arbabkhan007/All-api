...
| [AirportInfo](https://airport-timezone.hammond.zone/) | Worldwide airport database with DST-aware timezone lookups along with first light / last light | No | Yes | Yes |

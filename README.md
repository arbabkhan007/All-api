...
| [SOS Route](https://api.sosroute.dev/v1) | Real-time location safety intelligence — risk scores, hazard alerts, emergency contacts for any GPS coordinate | `apiKey` | Yes | Yes |

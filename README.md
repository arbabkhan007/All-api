...
| [Kairos Signal](https://kairossignal.com) | Real estate distressed property leads, federal contract data, weather/seismic feeds, and 3072-dimensional DAG manifold correlation engine | `apikey` | Yes | Yes |

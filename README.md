...
| [PlayerElo](https://playerelo.football/api-access) | Player-level Elo ratings for 160K+ footballers and 11K+ coaches, with match predictions and transfer valuations | `apiKey` | Yes | Yes |

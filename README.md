...
| [Setup Gear Guide](https://setupgearguide.com/api-docs) | Keyless catalog API: specs, scores, compatibility & builds for PC, camera, audio & sim-racing gear | No | Yes | Yes |

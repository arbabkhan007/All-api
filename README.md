...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [Package Drift & Vulnerability Intelligence](https://api.pkgdrift.com) | Package intelligence and trust signals for npm, PyPI, Cargo, RubyGems, and NVD | `apiKey` | Yes | Unknown |

...
| Shazam / ShazamKit | Music recognition framework for identifying songs from audio input and matching them with Apple’s Shazam database | Apple Developer Authentication | Yes | Unknown | https://developer.apple.com/shazamkit/ |

...
| [TextLens](https://ckmtools.dev/api/) | Readability scoring (8 formulas: Flesch-Kincaid, Gunning Fog, SMOG, Coleman-Liau, ARI, Dale-Chall, Linsear Write), sentiment, and keyword extraction | `apiKey` | Yes | Unknown |

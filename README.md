...
| [Count API](https://countapi.mileshilliard.com) | A free, no auth counting service used to track hits and events. A drop-in replacement for countapi.xyz | No | Yes | Yes |

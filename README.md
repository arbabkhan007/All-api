...
| [Windy - Map Forecast](https://api.windy.com/map-forecast/docs) | Get weather map layers | `apiKey` | Yes | Unknown |
| [Windy - Point Forecast](https://api.windy.com/point-forecast/docs) | Get the weather forecast for a set of coordinates | `apiKey` | Yes | Unknown |

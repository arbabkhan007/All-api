...
| [GoldBean](https://goldbean-api.xyz) | Baidu AI APIs (OCR/TTS/ASR/LLM/HelixFold3) via MCP with x402 crypto payments, PayPal, Alipay. 150+ endpoints. Protein structure prediction (Nature-published). | `x402` | Yes | Yes |
